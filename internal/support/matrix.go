...
var Matrix = []Capability{
	...
	{"runtime-queue", "Runtime queue persistence", "Native add, list, remove for runtime-queue.json", "Not PowerShell-owned", "Go", "inert runtime metadata", "unit tests", "planned operator surface", "foundation migrated", "Keep execution/draining out of queue v1", "none"},
