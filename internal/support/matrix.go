...
var Matrix = []Capability{
	...
	{"init-repair", "Workspace init/repair", "Not native", "Implemented", "PowerShell", "mutating skeleton/config", "PowerShell manual coverage", "none", "not migrated", "Migrate before PowerShell deprecation", "migrate next"},
