...
var Matrix = []Capability{
	...
	{"runtime-queue", "Runtime queue persistence and inspection", "Native add, list, inspect, remove for runtime-queue.json", "Not PowerShell-owned", "Go", "inert runtime metadata / read-only diagnostics", "unit tests", "planned operator surface", "foundation migrated", "Keep execution/draining out of queue v1", "none"},
