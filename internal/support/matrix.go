...
var Matrix = []Capability{
	...
	{"runtime-scheduler", "Runtime scheduler planning", "Native scheduler plan selects first eligible runnable queue item from queue plan", "Not PowerShell-owned", "Go", "read-only scheduling decision", "unit tests", "none", "contract migrated", "Keep execution out of scheduler v1", "none"},
