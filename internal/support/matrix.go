...
var Matrix = []Capability{
	...
	{"runtime-execution-records", "Runtime execution record persistence and inspection", "Native list, inspect, and plan-from-reservation for runtime-executions.json", "Not PowerShell-owned", "Go", "inert execution intent metadata / read-only diagnostics", "unit tests", "none", "contract migrated", "Keep provider execution out of execution-record v1", "none"},
